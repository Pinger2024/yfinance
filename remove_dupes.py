...
def clean_up_duplicates():
    ...
    # Step 2: Execute the aggregation with allowDiskUse set to True
    duplicates = list(ohlcv_collection.aggregate(pipeline, allowDiskUse=True))
    ...
    for duplicate in duplicates:
        ...
        # Step 4: Keep the most recent record and delete others
